...
/** Mounts the Zip game into `app`. `onChangeGame` returns to the game selector. */
export function mountZip(app: HTMLDivElement, onChangeGame: () => void) {
